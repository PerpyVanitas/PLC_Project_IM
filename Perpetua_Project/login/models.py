...
class Class(models.Model):
    ...
    total_Mentees = models.IntegerField(validators=[MinValueValidator(1),
...
class Attendance(models.Model):
    stud_id = models.ForeignKey(Mentee, on_delete=models.CASCADE)
...
class Timetable(models.Model):
    ...
    day = models.CharField(max_length=9,choices=DAYS_CHOICE,default=None,blank=False)
    class_id = models.ForeignKey(Class, on_delete=models.CASCADE)
    periods= models.ForeignKey(Slot, on_delete=models.CASCADE)
    class Meta:
